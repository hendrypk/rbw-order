            ...
            <div class="bg-white dark:bg-gray-900 w-full max-w-xs rounded-3xl p-6 text-center shadow-2xl border border-gray-100 dark:border-gray-800 space-y-4 animate-in zoom-in-95 duration-200">
                ...
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <a 
                        ...
                        :href="`https://wa.me/6285814973157?text=${encodeURIComponent('Halo Admin, saya ingin mengonfirmasi pesanan saya.\n\nNo. Order: ' + (orderNumber || '-') + '\nDetail: ' + (orderItemSummary || '-') + '\nWaktu: ' + (orderSchedule || 'Sekarang'))}`" 
                        target="_blank" 
                        class="w-full py-3 rounded-xl font-bold text-xs text-white bg-emerald-500 hover:bg-emerald-600 shadow-md shadow-emerald-500/20 transition active:scale-95 flex items-center justify-center gap-2 text-center"
                    >
